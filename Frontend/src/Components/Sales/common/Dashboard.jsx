...
import { salesManagerListItems, guestListItems, customerListItems } from '../../components/listItems';
  ...
  useEffect(() => {
    switch (userRole) {
      case "salesManager": //salesManager
        setNavlinks(salesManagerListItems);
        if (userAPI != null) {
          setuserAPI('//sales')
          setAuth(true);
        }
        ...
        <AppBar position="absolute" open={open}>
          ...
          >
            ...
            <Typography
              ...
              sx={{ flexGrow: 1 }}
            >
              {userRole === 'salesManager' ? 'Sales Manager Dashboard' :
                userRole === 'customer' ? 'Cashier Dashboard' :
